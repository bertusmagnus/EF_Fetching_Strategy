...
{
    #region Specification Class Declaration

    public class Specification<T> : ISpecification<T>
    {
        #region Private Members

        private Func<T, bool> _evalFunc = null;
        ...
        public virtual bool Matches(T entity)
        {
    ...
    #region Supporting Classes for LINQ To SQL & Entity Framework support.

    /// <summary>
    /// Note: These classes are required for the Entity Framework V1
    /// and their purpose is to overcome the EF's inability to handle
    /// ExpressionInvocation. 
    /// See http://blogs.msdn.com/meek/archive/2008/05/02/linq-to-entities-combining-predicates.aspx
    /// </summary>
